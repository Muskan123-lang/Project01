...
namespace Nagarro.BookTheShow.DAL.Repository
{
    ...
    {
        private readonly BookMyTicketsContext _dbContext;

        public MovieSlotRepository(BookMyTicketsContext dbContext)
        {
        ...
        {
            var st = new EFModels.MovieSlot { MovieId=movieslot.MovieId,MovieTime = movieslot.MovieTime, Fare=movieslot.Fare,MovieDate=movieslot.MovieDate,MaxSeats=movieslot.MaxSeats,AvailableSeats=movieslot.AvailableSeats };
            _dbContext.Add(st);
